...
export function Footer() {
  return (
    <footer className="border-t border-[rgba(43,88,118,0.15)] bg-cream py-14 md:py-16">
      <Container>
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-10 lg:grid-cols-5 lg:items-start lg:gap-8 xl:gap-10">
          <div className="max-w-sm self-start">
            <BrandLogo imageClassName="h-14 w-auto sm:h-16 md:h-20 lg:h-24" />
            <p className="mt-4 text-base leading-relaxed text-muted">{SITE_CONFIG.footerTagline}</p>
          </div>
